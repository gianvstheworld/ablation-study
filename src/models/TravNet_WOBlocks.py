...
class TravNet_WOBlocks(nn.Module):
    def __init__(self, params):
        ...
        self.convTrans2 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=128+256, out_channels=128, kernel_size=2, stride=2),
            nn.BatchNorm2d(128),
            nn.ReLU(inplace=True),
        ...
        self.convTrans3 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=64+128, out_channels=64, kernel_size=2, stride=2),
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
        ...
        self.convTrans4 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=32+64, out_channels=32, kernel_size=2, stride=2),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
        ...
        self.convTrans5 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=32+32, out_channels=32, kernel_size=2, stride=2),
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True),
